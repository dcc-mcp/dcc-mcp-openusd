...
description: >-
  ...
  UsdGeomCamera, DistantLight, SphereLight, HDR DomeLight, and set transforms on prims.
license: MIT
...
metadata:
  dcc-mcp:
    ...
    version: "0.1.0"
    layer: domain
    search-hint: "openusd usd camera light distant sphere dome HDRI transform translate rotate scale"
    tags: "openusd, usd, camera, light, distant-light, sphere-light, dome-light, hdri, transform"
    tools: tools.yaml
---
