...
description: >-
  ...
  reference arcs to external assets. Create portable UsdGeom.Points primitives
  for particles, sparks, and point-based FX.
license: MIT
...
metadata:
  dcc-mcp:
    ...
    version: "0.1.0"
    layer: domain
    search-hint: "openusd usd stage create list prim define xform reference points particles fx asset scene.usda"
    tags: "openusd, usd, stage, prims, references, points, particles, fx"
    tools: tools.yaml
---
...
effects with widths, colors, velocities, and stable ids.
